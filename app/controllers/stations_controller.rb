class StationsController < ApplicationController
  ...
  def index
     ...
     @tracks = client.tracks({
       ...
       :"duration[from]" => params[:duration_from].to_i > 0 && params[:duration_from].to_i*60*1000 || 2*60*1000, # ms, 1*60*1000 = 2 minute
       :"duration[to]"   => params[:duration_to].to_i > 0 && params[:duration_to].to_i*60*1000 || 10*60*1000, # ms, 10*60*1000 = 10 minutes
